...
export default function HomePage(props) {
  ...
  return (
    ...
    justify-center pb-10'>
      <h1 className='text-white font-semibold text-5xl sm:text-6xl md:text-7xl'>
        Scribe<span className='text-yellow-400 bold'>It</span></h1>
      <h3 className='text-white font-medium md:text-lg'>Record <span className='text-blue-400'>&rarr;
        ...
        gap-4 mx-auto w-72 max-w-full my-4'>
            <p className='text-yellow-400'>{recordingStatus === 
        ...
        <p className='text-white'>Or <label className='text-yellow-400 cursor pointer
